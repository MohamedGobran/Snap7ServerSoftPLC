...
{
    public class BitAwareAddVariableDialog : Form
    {
        ...
        public BitAwareAddVariableDialog(PLCDataBlock dataBlock)
        {
        ...
        private void InitializeComponent()
        {
            ...
            // Form properties
            this.Text = "Add Variable - Bit Addressing";
        ...
        private void BtnAutoOffset_Click(object? sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (IsOffsetAvailableForNonBool(offset, requiredSize))
                    {
        ...
        private bool ValidateInput()
        {
            ...
            // Name uniqueness
            if (dataBlock.Variables.Any(v => v.Name.Equals(txtVarName.Text.Trim(), StringComparison.OrdinalIgnoreCase)))
            {
            ...
            if (dataType == "BOOL")
            {
                ...
                if (!BitAddressingHelper.IsBitAddressAvailable(dataBlock.Variables, byteOffset, bitOffset, dataBlock.Size))
                {
            ...
            {
                int size = GetCurrentDataTypeSize();
                if (!IsOffsetAvailableForNonBool(byteOffset, size))
                {
        ...
        private bool IsOffsetAvailableForNonBool(int offset, int size)
        {

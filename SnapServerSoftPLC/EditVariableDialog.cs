...
namespace SnapServerSoftPLC
{
    public partial class EditVariableDialog : Form
    {
        ...
        public EditVariableDialog(string currentName, string currentType, int currentOffset, string currentComment)
        {
            InitializeComponent();
            
            SetupDynamicContent(currentName, currentType, currentOffset, currentComment);
        }
        
        private void SetupDynamicContent(string currentName, string currentType, int currentOffset, string currentComment)
        {
            if (this.DesignMode) return;
            
            // Set current values only at runtime
            txtVarName.Text = currentName;
            cmbVarType.SelectedItem = currentType;
            numVarOffset.Value = currentOffset;
            txtVarComment.Text = currentComment;
            this.Text = $"Edit Variable - {currentName}";
        }
